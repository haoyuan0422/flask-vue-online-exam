...
const state = {
  ...
  menu: [{
    ...
    // },
    {
      ...
      content:[{item1:'学生成绩查询',path:'/allStudentsGrade'},{path: '/grade'},{item2: '成绩分段查询',path: '/selectExamToPart'},{path: '/scorePart'},{item3: '成绩数据统计',path: '/studentTranscript'},{path: '/studentGradeRanking'}],
    },
    {
      index: '4',
      title: '学生管理',
