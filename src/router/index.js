  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/studentTranscript', //成绩排名查询
          component: () => import('@/components/teacher/studentTranscript')
        },
        {
          path: '/studentGradeRanking', //学生成绩数据统计
          component: () => import('@/components/teacher/studentGradeRanking')
        },
        {
        ...
        },
        {
          ...
          component: () => import ('@/components/admin/adminMessageManage')
        },
        {
          path: '/teacherMessageManage',
          component: () => import ('@/components/teacher/teacherMessageManage')
        }
      ]
    },
    {
      ...
      children: [
        ...
        {path: '/MyMessage', component: () => import("@/components/student/MyMessage")}
      ]
    },
